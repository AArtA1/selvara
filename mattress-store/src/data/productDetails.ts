...
export const productDetails: Record<string, ProductDetail> = {
  "selvara-linen": {
    ...
    specs: [
      { label: "Жёсткость", value: "Твёрдый" },
      { label: "Конструкция", value: "Пружинный" },
      { label: "Высота", value: "21 см" },
    ],
    description:
  ...
  "selvara-origin": {
    ...
    specs: [
      { label: "Жёсткость", value: "Средний" },
      { label: "Конструкция", value: "1024 пружины/м²" },
      { label: "Высота", value: "23 см" },
    ],
    description:
  ...
  "selvara-latex": {
    ...
    specs: [
      { label: "Жёсткость", value: "Средний / Твёрдый" },
      { label: "Конструкция", value: "Беспружинный" },
  ...
  "selvara-signature": {
    ...
    specs: [
      { label: "Жёсткость", value: "Мягкий / Средний" },
      { label: "Конструкция", value: "1024 пружины/м²" },
      { label: "Высота", value: "25 см" },
    ],
    description:
